...
## 🚀 Key Features
* **Data Cleaning & EDA:** Comprehensive analysis using Pandas, Matplotlib, and Seaborn.
* **Interactive Dashboard:** Visualizing KPIs like Retention Rate, Attrition by Department, and Job Satisfaction.
* **Insightful Trends:** Identifying the core reasons behind employee departures.
